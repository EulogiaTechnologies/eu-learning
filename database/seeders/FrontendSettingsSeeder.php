...
class FrontendSettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('frontend_settings')->insert([
            ...
            ['id' => 40, 'key' => 'contact_info', 'value' => '{"email":"admin@eulogia.net","phone":"07048102345","address":"629 12th St, Modesto","office_hours":"8","location":"40.689880, -74.045203"}', 'created_at' => '2023-10-31 11:08:12', 'updated_at' => '2024-09-11 04:57:26'],
